...
export const LottieAnimations = {
  ...
  miningRestart: require('./mining-restart.json'),
  ...
  bonusSmall: require('./bonus-small.json'),
  bonusClaim: require('./bonus-claim.json'),
  bonusExpired: require('./bonus-expired.json'),
};
